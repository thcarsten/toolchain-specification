...
REPOSITORY CONTEXT
- Location: toolchain-specification/pipeline generator/. Compilers under src/compilers/, grouped into per-framework subfolders (core/, ldio/, nifi/, rdfc/, sw/). End-to-end walkthrough in src/demo.ipynb. Sample catalog split by framework in data/catalog/catalog-ldio.ttl + data/catalog/catalog-nifi.ttl + data/catalog/catalog-rdfc.ttl + data/catalog/catalog-sw.ttl.
...
- Component / Catalog: a component is a reusable pipeline building block; the catalog is the RDF library of all available components (data/catalog/catalog-ldio.ttl + data/catalog/catalog-nifi.ttl + data/catalog/catalog-rdfc.ttl + data/catalog/catalog-sw.ttl).
