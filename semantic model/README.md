...
| **subclass of** | prov:SoftwareAgent, spdx:Build |
<br>
...
| | |
|----------|----------|
| **Definition** | A File describes the output artifacts that the PipelineGenerator produces as part of the Pipeline Build. A File has a filename, filepath and content. These are attached to an spdx:File via tcs:filename, tcs:filepath and tcs:literal, respectively. We use tcs:literal here because currently file content is exclusively expressed as literal strings of various formats (yaml, json, ttl ...). |
| **subclass of** | --- |
<br>
